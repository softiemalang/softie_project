...
function createDeterministicBasePackage({ subjectName, systems, rootInput = {}, unifiedContext = null }) {
  ...
  const normalizedInput = {
    ...
    administrativeAreaCode: rootInput.administrativeAreaCode || sajuInput.administrativeAreaCode || null,
    administrativeAreaName: rootInput.administrativeAreaName || sajuInput.administrativeAreaName || null,
    locationResolution: rootInput.locationResolution || sajuInput.locationResolution || null,
    coordinateMethod: rootInput.coordinateMethod || sajuInput.coordinateMethod || null,
    coordinateProvenance: rootInput.coordinateProvenance || sajuInput.coordinateProvenance || null,
