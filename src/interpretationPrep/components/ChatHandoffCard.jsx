...
export function ChatHandoffCard({ unifiedContext = {} }) {
  ...
  return (
    <div className="prep-handoff-card">
      <p className="section-kicker">03 · CHAT HANDOFF</p>
      ...
      {handoffPackage && (
        <div className="prep-handoff-actions-wrap">
          ...
          <div className="prep-handoff-copy-options">
            ...
            >
              전체 복사 ({handoffPackage?.characterCounts?.full || 0}자)
            </button>
            ...
            >
              간편 복사 ({handoffPackage?.characterCounts?.quick || 0}자)
            </button>
            ...
            >
              질문 중심 복사 ({handoffPackage?.characterCounts?.topicFocused || 0}자)
            </button>
            ...
            >
              개인정보 보호 익명 복사 ({handoffPackage?.characterCounts?.privacyMinimal || 0}자)
            </button>
          </div>
          ...
          <div className="prep-quality-guide">
            ...
            <ul>
              <li>세 체계 용어를 억지로 인과관계로 섞지 않는지 확인하세요.</li>
