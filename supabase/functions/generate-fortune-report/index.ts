...
- 최종 JSON을 반환하기 전에 조용히 한 번 더 점검하고, 필요하면 바로 고쳐 쓰세요.
- health 섹션에 정확히 "규칙적 식사", "규칙적인 식사", "가벼운 스트레칭", "짧은 스트레칭"이 들어가면 안 됩니다. 이 표현이 보이면 몸의 리듬, 쌓인 긴장, 호흡, 몸의 무게감, 회복 시간, 자극 줄이기 같은 흐름으로 다시 써 주세요.
- cautions는 반드시 행동형 문장이어야 합니다. "~할 수 있어요", "~할 수 있음", "~이 생길 수 있어요", "~이 생길 수 있음", "~에 주의"로 끝나면 안 됩니다. 그런 형태가 있으면 바로 고르고, 듣고, 멈추고, 덜어내고, 나누고, 확인하는 행동 문장으로 다시 쓰세요.
- action_tip은 가장 강한 흐름에 맞는 1~3분짜리 행동인지 확인하세요. health가 가장 강하지 않다면 식사나 스트레칭보다 말하기 전 멈추기, 한 줄 적기, 우선순위 확인, 결제 전 재확인처럼 더 직접적인 행동을 우선 쓰세요.
...
- 건강: "책임감이 몸의 무게감으로 이어지기 쉬운 날이에요. 오늘은 무리한 속도보다 회복 시간을 먼저 챙겨보세요."
- 건강: "말과 생각이 많아지는 흐름에서는 호흡이 얕아지기 쉬워요. 잠깐 눈을 쉬게 하고 몸의 힘을 풀어보세요."
- 주의점: "눈에 잘 드러나지 않는 부담은 쌓이기 전에 잠깐 덜어내세요."
- 주의점: "민감한 반응이 올라올 땐 바로 말하기보다 한 번 숨을 고르세요."
- 주의점: "가까운 관계에서는 상대의 말을 끝까지 듣고 천천히 답해보세요."
