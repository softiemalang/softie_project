...
- health 섹션에서 식사, 스트레칭, 휴식이 나오더라도 오늘의 긴장감이나 리듬과 연결해 쓰세요. 단독 습관 문장처럼 끝내지 말고, 왜 그 행동이 필요한지 함께 적으세요.
...
- action_tip은 "중요한 말은 한 번 고르고 천천히 전해보세요.", "보내기 전 문장을 한 번만 다시 읽어보세요."처럼 실제로 바로 할 수 있는 문장으로 쓰세요.
...
- 건강: "몸의 긴장이 천천히 쌓일 수 있어 리듬을 무리하게 흔들지 않는 편이 좋아요. 가벼운 움직임과 짧은 휴식으로 균형을 돌려보세요."
- 주의점: "눈에 잘 드러나지 않는 부담은 쌓이기 전에 잠깐 덜어내세요."
- 주의점: "가까운 관계에서는 바로 반응하기보다 한 번 숨을 고르세요."
- action_tip: "중요한 말은 한 번 고르고 천천히 전해보세요."`;
