...
- health 섹션은 오늘의 흐름과 연결해 쓰세요. 몸 상태를 일반 건강 앱처럼 분리하지 말고, 에너지의 몰림/분산과 리듬 조절을 함께 보여주세요. 예를 들어 "생각과 말이 많아지며 몸도 살짝 긴장하기 쉬운 날이에요. 가벼운 움직임과 휴식으로 리듬을 천천히 풀어보세요."처럼 쓰세요.
...
- cautions는 명사형과 명령형이 섞이지 않게 문장 톤을 통일하세요. "즉흥적인 반응은 한 번 멈춰보세요."처럼 쓰세요.
- action_tip은 1~3분 안에 할 수 있는 작은 행동을 우선 제안하세요. "잠깐 눈을 감고 세 번만 천천히 숨을 쉬어보세요."처럼 부담 없이 끝낼 수 있게 쓰세요.
...
- 관계: "대화가 원활해 내 마음과 분위기가 자연스럽게 전해지기 쉬운 날이에요. 예민한 반응에는 잠깐 숨을 고른 뒤 말해보세요."
- 건강: "생각과 말이 많아지며 몸의 긴장도 함께 올라오기 쉬운 날이에요. 가벼운 스트레칭과 충분한 휴식으로 리듬을 천천히 돌려보세요."
- 주의점: "감정 표현은 바로 꺼내기보다 한 번 고르고 전해보세요."
- 주의점: "중요한 결정은 즉흥보다 한 번 더 생각한 뒤 움직여보세요."`;
