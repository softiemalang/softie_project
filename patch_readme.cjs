...
- \`BACKUP_CRON_SECRET\`: Required. The \`google-drive-scheduled-backup\` endpoint fails closed when it is missing and rejects requests without the matching bearer token.`
);
