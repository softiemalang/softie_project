...
import {
  SAJU_GEMINI_V7_PARENT_SCHEMA,
  SAJU_GEMINI_V7_PARENT_VERSION,
  buildSajuGeminiV7ParentAdjudication,
} from '../src/interpretationPrep/sajuGeminiV7ParentAdjudication.js'

export const SCHEMA = SAJU_GEMINI_V7_PARENT_SCHEMA
export const VERSION = SAJU_GEMINI_V7_PARENT_VERSION
export const ARTIFACT_PATH = 'artifacts/saju-gemini-v7-parent-adjudication/complete.json'
...
export const INPUT_PATHS = [
  ...
  'src/interpretationPrep/sajuGeminiV7ParentAdjudication.js',
  ...PREDECESSOR_PATHS,
  'scripts/materialize-saju-gemini-v7-parent-adjudication.mjs',
]
...
export async function buildArtifact() {
  ...
  const artifact = buildSajuGeminiV7ParentAdjudication({
    basisHead,
