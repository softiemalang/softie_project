...
import {
  SAJU_GEMINI_WITNESS_DOSSIER_V2_SCHEMA,
  SAJU_GEMINI_WITNESS_DOSSIER_V2_VERSION,
  buildSajuGeminiWitnessDossierAdjudicationV2,
} from '../src/interpretationPrep/sajuGeminiWitnessDossierAdjudicationV2.js'

export const SCHEMA = SAJU_GEMINI_WITNESS_DOSSIER_V2_SCHEMA
export const VERSION = SAJU_GEMINI_WITNESS_DOSSIER_V2_VERSION
export const ARTIFACT_PATH = 'artifacts/saju-gemini-witness-dossier-adjudication-v2/complete.json'
...
export const PREDECESSOR_PATHS = [
  ...
  'artifacts/saju-luna-p0-evidence-acquisition-adjudication-v2/complete.json',
]
export const INPUT_PATHS = [
  ...
  ...PREDECESSOR_PATHS,
  'scripts/materialize-saju-gemini-witness-dossier-adjudication-v2.mjs',
]
...
export async function buildArtifact() {
  ...
  const artifact = buildSajuGeminiWitnessDossierAdjudicationV2({
    basisHead,
