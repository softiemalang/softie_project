...
if (process.argv[1] === new URL(import.meta.url).pathname) {
  ...
  console.log(JSON.stringify({
    ...
    claimTypeCounts: artifact.summary?.claimTypeCounts || null,
    promotionNearClaimCount: artifact.summary?.promotionNearClaimIds?.length || 0,
    promotionReadyClaimCount: artifact.summary?.promotionReadyClaimIds?.length || 0,
