...
import { buildPilotArtifact, canonicalJson, BASIS_HEAD, MATERIALIZER_VERSION, SCHEMA, SOURCE_PDF, SOURCE_PDF_SHA256 } from './materialize-ziwei-tianfu-star-placement-clean-rule-seed-pilot-v0.mjs'
