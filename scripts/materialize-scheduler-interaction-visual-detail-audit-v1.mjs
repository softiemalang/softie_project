...
function flowAuditLedger() {
  return {
    ...
    flows: [
      ...
      { flowId: 'FLOW-5-RESERVATION-EDIT-DELETE', outcome: 'fix_and_hold', result: 'delete uses preserved transition return; save destination held', sourceRefs: [workingRef('src/scheduler/ReservationEditorPage.jsx', 'navigate(backPath, { viewTransition: true })')] },
