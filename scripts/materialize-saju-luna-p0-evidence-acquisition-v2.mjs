...
import {
  SAJU_LUNA_P0_SCHEMA,
  SAJU_LUNA_P0_VERSION,
  buildSajuLunaP0EvidenceAcquisitionV2,
} from '../src/interpretationPrep/sajuLunaP0EvidenceAcquisitionV2.js'

export const SCHEMA = SAJU_LUNA_P0_SCHEMA
export const VERSION = SAJU_LUNA_P0_VERSION
export const ARTIFACT_PATH = 'artifacts/saju-luna-p0-evidence-acquisition-adjudication-v2/complete.json'
...
export const INPUT_PATHS = [
  ...
  'src/interpretationPrep/sajuLunaP0EvidenceAcquisitionV2.js',
  ...PREDECESSOR_PATHS,
  'scripts/materialize-saju-luna-p0-evidence-acquisition-v2.mjs',
]
...
export async function buildArtifact() {
  ...
  const artifact = buildSajuLunaP0EvidenceAcquisitionV2({
    basisHead,
