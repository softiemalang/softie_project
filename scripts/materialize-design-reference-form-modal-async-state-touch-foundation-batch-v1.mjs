...
function frontierDecisionLedger() {
  return {
    ...
    frontiers: [
      ...
      { frontierId: 'FRONTIER-MODAL-DIALOG-NAMES', decision: 'fix', sourceRefs: [workingTextRef('src/pages/SpotifyMusicPage.jsx', 'role="dialog" aria-label="Spotify 기기 볼륨 조절"'), workingTextRef('src/scheduler/SyncConfirmationModal.jsx', 'role="dialog"\n        aria-modal="true"\n        aria-label="근무 기록 변경 확인"')] },
      ...
      { frontierId: 'FRONTIER-BUSY-DUPLICATE-ACTIONS', decision: 'fix', sourceRefs: [workingTextRef('src/pages/HomePage.jsx', 'if (!text || isSendingMemoRef.current) return'), workingTextRef('src/scheduler/TodaySchedulerPage.jsx', 'if (!syncConfirmation || workLogSyncLockRef.current) return')] },
