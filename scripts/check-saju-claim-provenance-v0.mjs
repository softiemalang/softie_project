...
const errors = checkSajuClaimProvenanceArtifact(artifact)
if (canonicalJson(artifact) !== canonicalJson(expected)) errors.push('artifact drift or non-deterministic materialization')
