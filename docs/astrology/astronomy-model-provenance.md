...
- 태양 위치 계산 모델 후보 조사 결과 ERFA EPV00 controlled adaptation만 `selected_for_feasibility` 상태입니다. C/JavaScript conformance와 current Horizons DE441 heliocentric Earth/Earth→Sun 검증은 통과했습니다. 선택한 NAIF DE405 subset artifact는 mandatory 1900–2100 dates 전체를 덮지 않아 현재 `solarModelDecisionStatus: provisional`, `technicalModelStatus: blocked_by_incomplete_de405_diagnosis`입니다. Official JPL full-range candidate는 확보됐으나 `gfortran`·`flang`·`f77` 부재로 executable official reader 수치 검증이 차단됐으며, 비공식 parser나 wrapper는 사용하지 않았습니다. 출처·권리표·정책 판단은 [docs/astrology/solar-alternative-model-survey.md](file:///Users/softie/Documents/softie_project/docs/astrology/solar-alternative-model-survey.md) 및 [erfa-epv00-reference-ephemeris-delta.md](file:///Users/softie/Documents/softie_project/docs/astrology/erfa-epv00-reference-ephemeris-delta.md)에 기록합니다.
